...
def upgrade() -> None:
    ...
    sa.Column('occupied', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_index(op.f('ix_seat_occupied'), 'seat', ['occupied'], unique=False)
    op.create_index(op.f('ix_seat_ref_license'), 'seat', ['ref_license'], unique=False)
    op.create_index(op.f('ix_seat_released'), 'seat', ['released'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_seat_released'), table_name='seat')
    op.drop_index(op.f('ix_seat_ref_license'), table_name='seat')
    op.drop_index(op.f('ix_seat_occupied'), table_name='seat')
